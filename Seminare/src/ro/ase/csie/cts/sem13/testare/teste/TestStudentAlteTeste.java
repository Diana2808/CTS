...
public class TestStudentAlteTeste {
	// test fixture
		...
		@Test(expected = ExceptieVarsta.class)
		public void testSetVarstaRangMaxInt() throws ExceptieVarsta {
		...
		@Test
		public void testGetNtaMinimaInverseRelation() throws ExceptieNota  {
			ArrayList<Integer> note = new ArrayList<>();
			int nrNote = 10000;
			Random random = new Random();
			for(int i = 0; i< nrNote; i++) {
		...
		public void testGetMedieCrossCheck() throws ExceptieNota {
			...
			assertEquals("Valrile calculate de cele 2 functii nu sunt identice",medieEstimata, medieCalculata, 0);;
